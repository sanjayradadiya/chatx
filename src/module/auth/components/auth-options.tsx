...
interface AuthOptionsProps {
  signInWithAuthProvider: (authProvider: Provider) => Promise<void>;
}

const AuthOptions = ({ signInWithAuthProvider }: AuthOptionsProps) => {
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-4">
        <Button variant="outline" type="button" onClick={() => signInWithAuthProvider("github")}  className="w-full cursor-pointer">
        ...
        <Button variant="outline" type="button" onClick={() => signInWithAuthProvider("google")}  className="w-full cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
        ...
        <Button variant="outline" type="button" onClick={() => signInWithAuthProvider("facebook")}  className="w-full cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
