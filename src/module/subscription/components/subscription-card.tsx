...
export function SubscriptionCard({
  ...
  return (
    <Card className={cn(
      ...
      isPro && "before:absolute before:inset-0 before:inset-x-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-primary before:to-transparent"
    )}>
      {isPro && (
