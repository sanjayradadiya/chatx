        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto bg-card rounded-xl shadow-sm p-6 md:p-8">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-primary">Description of Service</h2>
                <p className="leading-relaxed">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-primary">User Accounts</h2>
                <p className="leading-relaxed">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-primary">Subscription Plans and Payment</h2>
                <p className="leading-relaxed">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-primary">User-Generated Content</h2>
                <p className="leading-relaxed">
